  ...
  if ($('.fav-btn').length) {
    {
      ...
      $('.fav-btn').each(function() {
        ...
        if (favSet.has(name)) {
          $(this).attr('src', '/public/img/icon/fav.png');
          return;
        }
      });
    }
    $('.fav-btn').click(function() {
      ...
      if (toggleFav(name)) {
        ...
        $(this).attr('src', '/public/img/icon/unfav.png');
      }
    });
  }
...
// share buttons
function share_button(sns,url,title,w,h) {
  var s = 'http://www.addtoany.com/add_to/' + sns;
  s += '?linkurl=' + window.location.protocol;
  s += '//' + window.location.hostname + encodeURIComponent(url);
  s += '&linkname=' + title;
